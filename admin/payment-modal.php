	...
	<div class="stylepress-payment-pop">
		<div class="stylepress-payment-popup">
			...
			<div class="form-row">
				...
				<input type="text" size="50" class="name text-field" name="name" placeholder="Your Name"
			...
			<div class="form-row">
				...
				<input type="email" size="50" class="email text-field" name="email" placeholder="Your Email"
