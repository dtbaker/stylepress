...
( function( $ ) {
  ...
  function show_slidein( slideinid ) {
    ...
    if ( $slidein.length ) {
      ...
      $( document ).on( 'keyup.stylepressmodal', function( e ) {
        if ( 27 == e.keyCode ) { // escape key maps to keycode `27`
          close_slideins();
        }
      });
  ...
  function open_popup() {
    ...
    if ( 'undefined' != typeof current_modal.display && 1 == current_modal.display ) {
    ...
    var width = '500px';
    if ( 'undefined' != typeof current_modal.settings && 'undefined' != typeof current_modal.settings.modal_width ) {
      width = current_modal.settings.modal_width;
    } else if ( 'undefined' != typeof current_modal.width ) {
