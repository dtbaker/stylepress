...
( function( $ ) {
  $.fn.GenerateMobileMenu = function( options ) {
    ...
    $( this ).on( 'click', function( e ) {
      ...
      $( this ).closest( settings.menu ).attr( 'aria-expanded', 'true' === $( this ).closest( settings.menu ).attr( 'aria-expanded' ) ? 'false' : 'true' );
  ...
  $( document ).ready( function() {
    ...
    $( document ).on( 'click', 'nav .dropdown-menu-toggle', function( e ) {
      ...
      if ( mobile.is( ':visible' ) || 'visible' == slideout.css( 'visibility' ) ) {
        ...
        _this.attr( 'aria-expanded', 'false' === $( this ).attr( 'aria-expanded' ) ? 'true' : 'false' );
      }
      return false;
    });
