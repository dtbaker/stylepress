...
?>
	...
	<ol>
		...
		<li>Choose which Inner Styles to apply to your site components. The Inner Styles are dynamic layouts that replace
			the default <code>the_content()</code> output.
		</li>
		<li>When editing individual pages you can apply a different style to the default, look in the page metabox area.
		</li>
		<li>Disable Theme CSS if the page layout looks funky (recommended).</li>
		<li>View more help and videos at <a href="https://stylepress.org/help/"
		                                    target="_blank">https://stylepress.org/help/</a></li>
	</ol>
<?php
