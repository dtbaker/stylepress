...
add_action( 'elementor_pro/forms/render_field/stylepress-togglestart', function ( $item, $item_index, $widget ) {
	...
	<input type="checkbox" class="stylepress-form-togglecheck" value="1"
	       id="stylepress-formtoggle-<?php echo $item_index; ?>">
	<label for="stylepress-formtoggle-<?php echo $item_index; ?>" class="stylepress-form-togglelabel"><span
			class="on"><?php echo $bits[0]; ?></span><span class="off"><?php echo $bits[1]; ?></span> </label>
